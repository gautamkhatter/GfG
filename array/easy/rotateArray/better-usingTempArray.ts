 ...
 * the array by 'k' (rotationLength) positions, the last n-k meaning lets
 ...
 * Function call:- rotateArrayUsingTempArray(nums);
 *
 * Function execution:
 *    • Iterations:=
 *          nums.length = n = 6
